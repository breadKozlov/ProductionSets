...
@WebServlet("/saveProductionAdmin")
public class SaveProductionAdminServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher(JspHelper.getPath("saveProductionAdmin")).forward(req, resp);
    }
