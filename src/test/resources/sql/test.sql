insert into brigades (name_of_brigade,phone_number_of_foreman)
values
    ('Brigade 1','+375291112233'),
    ('Brigade 2','+375293334455'),
    ('Brigade 3','+375295556677');

insert into schedule_hours (name_of_hour)
values
    ('8.00 - 20.00'),
    ('20.00 - 8.00'),
    ('8.00 - 17.00'),
...
insert into schedule (name_month, id_hour,id_brigade)
values
    ('January',1,1),
    ('January',2,2),
    ('January',3,3),
...
insert into workers (name_worker,surname_worker,speciality,rank,experience,brigade_number,email)
values
...
insert into sets_for_cars (name_of_set,num_of_parts,rate_of_set)
values
...
insert into set_materials (name_of_material,description)
values
...
insert into requirement (id_set,id_set_material,unit_cost,total_sets)
values
    (1,6,9.707,300),
    (2,6,9.3,200),
    (3,6,5.8,500),
...
insert into production (id_worker,id_set,made_sets,date_of_production)
values
    (1,1,250,'2023-04-04'),
    (1,4,100,'2023-04-05'),
    (1,3,150,'2023-04-05'),
...
insert into production_materials(id_set_material,id_brigade,quantity_of_raw_materials,date_of_production)
values
    (6,1,650,'2023-03-26'),
    (5,2,250,'2023-03-11'),
    (4,3,100,'2023-03-02'),
...
insert into workers_sets (id_set,id_worker,requirement)
values (1,2,300),
       (2,2,200),
       (1,3,100),
       (11,5,150),
